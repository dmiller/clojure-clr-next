...
let seqIteratorTests =
    testList
        ...
        [
          ...
          <| fun _ ->
              let e =
                  new SeqEnumerator(makeConsChain 3) :> IEnumerator

              testThreeElementSeqEnumerator e

          testCase "SeqIteratorReset at beginning"
          <| fun _ ->
              let e =
                  new SeqEnumerator(makeConsChain 3) :> IEnumerator
          ...
          testCase "SeqIteratorReset after move"
          <| fun _ ->
              let e =
                  new SeqEnumerator(makeConsChain 3) :> IEnumerator
          ...
          testCase "SeqIteratorReset at end "
          <| fun _ ->
              let e =
                  new SeqEnumerator(makeConsChain 3) :> IEnumerator
