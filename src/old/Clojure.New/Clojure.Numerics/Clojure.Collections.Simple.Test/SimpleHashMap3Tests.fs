...
let basicSimpleHashMap3CreateTests =
    ftestList
        ...
        [
          ...
          <| fun _ ->
              let a = ArrayList()
              let m = SimpleHashMap3.create1 (a)
    ...
    ftestList
        ...
        [
          ...
          <| fun _ ->
              ...
              let m1 = SimpleHashMap3.create (d)
              let m2 = m1.assoc (2, "c")
    ...
    ftestList
        ...
        [
          ...
          <| fun _ ->
              ...
              let m2 = SimpleHashMap3.create (d)
          ...
          <| fun _ ->
              ...
              let a = SimpleHashMap3.create (d) :> Associative
              let a1 = a.assoc (3, "c")
              let a2 = a.assoc (2, "c")
          ...
          testCase "cons on SimpleHashMap3 adds/repalces many"
          <| fun _ ->
              let d1: Dictionary<int, string> = Dictionary()
              d1.[1] <- "a"
              d1.[2] <- "b"

              let m1 = SimpleHashMap3.create (d1)

              let d2: Dictionary<int, string> = Dictionary()
              d2.[2] <- "c"
              d2.[3] <- "d"

              let m2 = SimpleHashMap3.create (d2)
              let m3 = m1.cons (m2)
...
let doBigTest (numEntries: int) =
    ...
    let m = SimpleHashMap3.create (dict)
