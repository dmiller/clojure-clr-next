module AlternateHashMapTests

open Expecto
open Clojure.Collections
open Clojure.Collections.Alternate
open TestHelpers
open System
    ...
    testList
        ...
        [
          ...
          <| fun _ ->
              ...
              let m = PHashMap.create1 (a) :> IPersistentMap
          ...
          <| fun _ ->
              ...
              let m = PHashMap.create (s) :> IPersistentMap
          ...
          <| fun _ ->
              let m = PHashMap.create () :> IPersistentMap
          ...
          <| fun _ ->
              let m = PHashMap.create (1, "a", 2, "b") :> IPersistentMap
          ...
          <| fun _ ->
              ...
              let m = PHashMap.create (meta :> IPersistentMap) :> IPersistentMap
          ...
          <| fun _ ->
              ...
              let m = PHashMap.create (meta, init) :> IPersistentMap
    ...
    testList
        ...
        [
          ...
          <| fun _ ->
              ...
              let a = PHashMap.createD2 (d) :> Associative
          ...
          <| fun _ ->
              ...
              let m1 = PHashMap.createD2 (d1)

              let d2: Dictionary<int, string> = Dictionary()
              d2.[2] <- "c"
              d2.[3] <- "d"

              let m2 = PHashMap.createD2 (d2)
              let m3 = m1.cons (m2)
          ...
          <| fun _ ->
              ...
              let id = PHashMap.createD2 (d) :?> IDictionary
          ...
          <| fun _ ->
              ...
              let c = PHashMap.createD2 (d) :?> ICollection
...
let testCollisions (numEntries: int) (numHashCodes: int) : unit =
    ...
    let mutable m = PHashMap.Empty :> IPersistentMap
