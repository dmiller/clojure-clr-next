...
let basicPersistentArrayMapPersistentCollectionTests =
    testList
        "Basic P.A.M PersistentCollection tests"
        [
...
let basicPersistentArrayMapPersistentMapTests =
    testList
        "Basic P.A.M PersistentMap tests"
        [
          ...
          <| fun _ ->
              ...
              let m1 = PersistentArrayMap.createD2 (d)
              let m2 = m1.assoc (2, "c")
...
let aPersistentMapTests =
    testList
        "APersistentMap tests for PersistentArrayMap"
        [
          ...
          <| fun _ ->
              ...
              d.[2] <- "c"
              let m2 = PersistentArrayMap.createD2 (d)
          ...
          <| fun _ ->
              ...
              let a =
                  PersistentArrayMap.createD2 (d) :> Associative
          ...
          <| fun _ ->
              ...
              let m = PersistentArrayMap.createD2 (d)
              let c = m.cons (DictionaryEntry(3:>obj, "c":>obj))
          ...
          <| fun _ ->
              ...
              let m = PersistentArrayMap.createD2 (d)
              let c = m.cons (DictionaryEntry(2:>obj, "c":>obj))
          ...
          <| fun _ ->
              ...
              let m = PersistentArrayMap.createD2 (d)
              let c = m.cons (KeyValuePair(3:>obj, "c":>obj))
          ...
          <| fun _ ->
              ...
              let m = PersistentArrayMap.createD2 (d)
              let c = m.cons (KeyValuePair(2:>obj, "c":>obj))
          ...
          testCase "cons on IPersistentVector replaces existing 2" <| fun _ ->
              let d : Dictionary<int,string> = Dictionary()
              d.[1] <- "a"
              d.[2] <- "b"

              let m = PersistentArrayMap.createD2(d)
              let f() = m.cons(PersistentVector.create(2,"c",3,"d")) |> ignore
          ...
          <| fun _ ->
              ...
              let m1 = PersistentArrayMap.createD2 (d1)

              let d2: Dictionary<int, string> = Dictionary()
              d2.[2] <- "c"
              d2.[3] <- "d"

              let m2 = PersistentArrayMap.createD2 (d2)
              let m3 = m1.cons (m2)
          ...
          <| fun _ ->
              ...
              let f = PersistentArrayMap.createD2 (d) :?> IFn
          ...
          <| fun _ ->
              ...
              let id =
                  PersistentArrayMap.createD2 (d) :?> IDictionary
...
let persistentArrayMapIObjTests =
    testList
        ...
        <| fun _ ->
            ...
            let m = PersistentArrayMap.createD2 (d) :?> IObj
